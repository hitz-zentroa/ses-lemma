...
MODEL='HiTZ/xlm-roberta-large-lemma-es'
OUTPUT_DIR='./'
LOGGING_DIR='./logs/xlm-roberta-large.log'
DIR_NAME='es_gsd_ses_udpipe'_${BATCH_SIZE_PER_GPU}_${WEIGHT_DECAY}_${LEARN_RATE}_${NUM_EPOCHS}_$(date +'%m-%d-%y_%H-%M')

python ./bsc_run_ner.py --model_name_or_path $MODEL --seed $SEED \
                                         --dataset_script_path ./es-gsd-dataset.py \
